...
fig = px.strip(
    ...
    y="diff_from_start",
    color="timer",
    hover_data=["diff_from_target", "diff_from_start"],
)
...
fig.add_trace(
    go.Box(
        ...
        customdata=np.array(
            [
                [dft, dfs]
                for dft, dfs in zip(dfm["diff_from_target"], dfm["diff_from_start"])
            ]
        ),
...
fig.write_html(
    "/home/pokgak/git/ba-plotscripts/docs/bgtimer_analysis/bgtimer_collision.html"
)
